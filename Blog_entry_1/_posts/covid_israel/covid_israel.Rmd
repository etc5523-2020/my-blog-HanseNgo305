...
For this exercise, i used a dataset provided from xxxx which can be obtained here..... for the information of the number of cases and deaths per day recording from 31 Dec 2019 up to the most recent (3 September 2020 by the day of this blog post).

Other information including the locations of cases, the age dispersion and the hospital status was obtained directly from the Israel Ministry of Health (MOH)'s daily dashboard and Telegram channel. 

The process of obtaining data was not easy as even though the Israel Government kept the public up to date with timely update and release of data and figures, most of them were published in Hebrew. The trace for data started from the Wikipedia page(..) where i obtained the offical data source of the MOH, then followed along a tidious work of tracking down the MOH's telegram and downloading every files offered since i did not know which was which. After the extensive use of google translate and googling (to verify the translation work) to decide what files to use, comes the even more tedious works of manually obtaining the GPS coordinates of each Israel cities appreared in the dataset for the mapping job later. It was bit a tricky that each cities written in Hebrew could yield quite some names in English due to the pronounciation difference, thus it was no easy job to match the name of the cities in the dataset with the ones in the GPS services. I would be deeply appreciated if anyone could suggest their solutions for
