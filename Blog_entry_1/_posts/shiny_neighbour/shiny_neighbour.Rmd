...
I tried to preserve the state of his code as much as could, but i could not make the code work if the source plot and event plot were not in the same place. Hopefully Dea could pick up from here and continue to develop his work further. 
...
(Well not "teaching" technically but you can relate)
