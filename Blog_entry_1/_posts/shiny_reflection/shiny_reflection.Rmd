...
```{r include-dashboard}
knitr::include_graphics(here::here("Blog_entry_1","dashboard.png"))
```

- The _Infection Route_ page will give you a nice 

```{r include-infectionroute}
knitr::include_graphics(here::here("Blog_entry_1","infection-route.png"))
```
